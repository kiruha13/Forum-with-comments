...
- Описать алгоритмы
## 1. [Пользовательский интерфейс](https://www.figma.com/file/OoXszTIiusU1alGn5qWHv0/Anonymus-chat?node-id=0%3A1&t=ynvczlcHTtZ2gQog-1)
## 2. Пользовательские сценарии работы
Пользователь попадает на главную страницу index.php. Вводит любое текстовое сообщение, по желанию может добавить картинку, следует нажать при создании поста на кнопку выбрать файл. В случае корректного ввода данных, его сообщение появится на общей стене в обратном хронологическом порядке, сначала новые, затем старые публикации. Пользователи могут ставить лайки на понравившиеся записи или убирать их в противном случае. Есть возможность удалять записи. Для этого пользователь нажимает на кнопку УДАЛИТЬ, и соответствующая запись удаляется. Пользователь может увидеть время каждого поста и добавить к ним комментарии.
